...
class Operations:
    ...
    def get_proteomes():
        ...
        proteomes=[Proteome('uniprot-proteusmirabilis.fasta', 'Proteus'),
                    Proteome('uniprot-Staphylococcusaureussubsp.aureusNCTC8325.fasta', 'Staphylo'),
                    Proteome('uniprot-taxonomy-Escherichiacoli562-.fasta', 'Ecoli')]
        return proteomes
    @classmethod
